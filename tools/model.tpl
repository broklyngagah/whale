...
func(op *{{op_struct_name}}) QueryByMapComparison(m map[string]interface{}) ([]*{{struct_name}}, error) {
    result := []*{{struct_name}}{}
    var params []interface{}
...
func(op *{{op_struct_name}}) QueryByClause(m map[string]interface{}, limit, offset int, orderby, clause []string) ([]*{{struct_name}}, error) {
    result := []*{{struct_name}}{}
    var params []interface{}
...
func (op *{{op_struct_name}}) QueryByPlayerId(player_id int) ([]*{{struct_name}}){
    sql := "{{select_all_sql}} where player_id=?"
    result := []*{{struct_name}}{}
