...
const InstKey = "pNJTlqboPiNhQHby"

var keys = [16]byte{102, 73, 102, 107, 53, 71, 51, 101, 113, 109, 87, 66, 43, 68, 52, 90}
...
func Encrypt(data []byte) []byte {
	...
	return toBytes(encrypt(toUint32s(data, true), toUint32s(keys[:], false)), false)
}
...
func Decrypt(data []byte) []byte {
	...
	return toBytes(decrypt(toUint32s(data, false), toUint32s(keys[:], false)), true)
}
